...
| `byte`      | Data type                 | used to define a varible or function return type that stores 8-bit integers.                                                                                             |
...
| `double`    | Data type                 | used to define a variable or function return type that stores 64-bit floatint points.                                                                                    |
...
| `float`     | Data type                 | used to define a varible or function return type that stores 32-bit floating points.                                                                                     |
...
| `int`       | Data type                 | used to define a variable or function return type that stores 32-bit integers.                                                                                           |
...
| `long`      | Data type                 | used to define a variable or function return type that stores 64-bit integers.                                                                                           |
...
| `short`     | Data type                 | used to define a varible or function return type that stores 16-bit integers.                                                                                            |
...
| `ubyte`     | Data type                 | unsinged version of byte.                                                                                                                                                |
| `ushort`    | Data type                 | unsinged version of short.                                                                                                                                               |
| `uint`      | Data type                 | unsinged version of int.                                                                                                                                                 |
| `ulong`     | Data type                 | unsinged version of long.                                                                                                                                                |
